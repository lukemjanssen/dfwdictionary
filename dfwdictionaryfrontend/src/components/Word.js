...
export default function Word() {
  ...
  const handleClickSortAscending = (e) => {
    fetch("http://7384:8080/word/sortByLengthAsc")
      .then((res) => res.json())
      .then((result) => {
        setWords(result);
      });
  ...
  const handleClickSortDescending = (e) => {
    fetch("http://7384:8080/word/sortByLengthDesc")
      .then((res) => res.json())
      .then((result) => {
        setWords(result);
      });
  ...
  const handleClickDelete = (e) => {
    ...
    console.log(id);
    fetch("http://7384:8080/word/delete/" + id, {
      method: "DELETE",
    }).then(() => {
  ...
  useEffect(() => {
    fetch("http://7384:8080/word/getAll")
      .then((res) => res.json())
      .then((result) => {
        setWords(result);
      });
